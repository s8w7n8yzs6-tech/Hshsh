...
_BASE_RULES = (
    "Você cria conteúdo para o Instagram de um trader brasileiro: notícias de "
    "mercado explicadas com clareza e a mente de quem opera. Escreva SEMPRE em "
    f"{config.POST_LANGUAGE}, incluindo hashtags. "
    "Nunca em inglês.\n"
...
_FMT = {
    ...
    "historia": {
        ...
        "main": "cover",
        "prompt": (
            "Formato NOTÍCIA EXPLICADA (um CARROSSEL do Instagram) sobre a MANCHETE de "
            "mercado/economia/negócios indicada abaixo. Você escreve como um bom "
            "jornalista econômico: leve o leitor além da manchete — explique o "
            "MECANISMO (por que isso acontece), o que está em jogo, quem ganha e quem "
            "perde, e o que observar daqui pra frente. Público: traders, empresários e "
            "gente analítica; nada de obviedade, nada de encher linguiça. Frases "
            "curtas, concretas e sem jargão vazio.\n"
            "REGRAS: baseie-se na manchete; NÃO invente números específicos, "
            "percentuais, datas exatas nem falas entre aspas — use apenas o que estiver "
            "na manchete; se não tiver certeza de um dado, explique o mecanismo em "
            "termos gerais. Nunca recomende compra/venda nem dê alvo de preço.\n"
            "Produza:\n"
            "- cover: o gancho da CAPA (máx ~72 caracteres) — reescreva a manchete de "
            "forma afiada e clara, que faça parar a rolagem. Sem clickbait mentiroso.\n"
            "- image_query: uma busca CURTA em INGLÊS (2 a 4 palavras) de uma FOTO "
            "concreta que represente visualmente o tema (ex.: 'new york stock "
            "exchange', 'oil refinery', 'semiconductor chips', 'brazilian real "
            "banknotes', 'central bank building', 'supermarket shopping'). Sem "
            "texto/logos/pessoas específicas.\n"
            "- slides: de 4 a 5 capítulos, cada um {titulo (máx ~28 caracteres), texto "
            "(máx ~230 caracteres)}. Cada capítulo precisa acrescentar informação nova "
            "— sugestão de arco: 'O que aconteceu', 'Por que isso acontece', 'Quem "
            "ganha, quem perde', 'No seu bolso', 'De olho na frente'.\n"
            "- caption: legenda do post (máx ~500 caracteres) que resume o fio e "
            "termina com uma pergunta ao leitor, 1-2 emojis, e 3-5 hashtags no fim."
        ),
    },
    "mercado": {
        "schema": {"headline": {"type": "string"}, "caption": {"type": "string"}},
